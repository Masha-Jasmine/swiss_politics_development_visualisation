            ...
            if (jahre.indexOf(jahr) > -1){
                for (var i in mousemoveDaten){
                    if (mousemoveDaten[i]["Wahljahr"] == jahr){
                        ...
                        if (canton == "Schwyz"){
                            console.log(canton + jahr + jahre + werte)
                        }
                    }
                }
            }
                ...
                if (jahre.indexOf(jahr) > -1){
                    for (var i in giveColorDaten){
                        if (giveColorDaten[i]["Wahljahr"] == jahr){
                            ...
                            console.log(canton + jahr)
                            console.log(maxWahl);
                            console.log(maxPartei);
                            if (maxWahl > 1){
                                console.log(farben[maxPartei]);
