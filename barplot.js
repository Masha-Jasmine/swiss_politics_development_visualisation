...
function barplot(plotCanton) {
    ...
    d3.csv("Komplett_Version.csv" , function(data) {
        ...
        /*selection.selectAll("text")
               .data(function(d) { return subCategories.map(function(key) { return {key: key, value: d[key]}; }); })
                .enter().append("text")
                .attr("x", d => xx1(d.key) -2)
                .attr("y", d => d.value<=0 ? yy(0) - (yy(4) - (Math.abs(yy(d.value) - yy(0)) + 132)) : yy(d.value) - 5)
        ...
        console.log(barAusgewählt);
        console.log(plotCanton[0]);
